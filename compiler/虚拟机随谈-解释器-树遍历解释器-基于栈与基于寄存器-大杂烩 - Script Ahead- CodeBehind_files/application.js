...
(function() {
  ...
  function toJSON(object) {
    ...
    if (object === null) return 'null';
    if (object.toJSON) return object;
...
(function() {
  ...
  function toJSON() {
    ...
    this.each(function(object) {
      ...
      if (!Object.isUndefined(object)) results.push(object);
    });
    return results;
  }
  ...
  onSubmit :  function(ev){
    if(this.form.spinner && this.form.spinner.visible()) {
      ...
      if(this.form.spinner) {
        ...
        this.form.spinner.src = 'https://www.iteye.com/images/spinner.gif';
...
Ajax.JSONResponse = Class.create({
  ...
  (function(){
    ...
    function init_notification_menu() {
      ...
      notifications_summary.update('<div class="menu_title clearfix"><span class="title">提醒</span><span class="all"><a href="https://my.iteye.com/notifications">查看所有 »</a></span></div>');
    ...
    function update_unread_count(pe) {
      new Ajax.JSONRequest('https://n.iteye.com/notifications/unread_count.json', {
        method: "get",
